...
--QBCore.Commands.Add('level', Lang:t('command.level.help'), {}, false, function(source)
--    local PlayerJob = QBCore.Functions.GetPlayer(source).PlayerData.job
--    TriggerClientEvent('QBCore:Notify', source, Lang:t('info.job_info', { value = PlayerJob.grade.name }))
--end, 'user')

-- Job

QBCore.Commands.Add('level', Lang:t('command.job.help'), {}, false, function(source)
    local PlayerJob = QBCore.Functions.GetPlayer(source).PlayerData.job
