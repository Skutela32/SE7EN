...
DS_Casino_System_Main_Config = {
    ...
    MapType = 'AUTODETECT', --'AUTODETECT' / 0 = IPL / 1 = UNCLEJUST / 2 = K4MB1 / 3 = GABZ / 4 = CUSTOM MAP (CHECK config_custom_map) / 5 = forum.cfx.re/t/the-diamond-casino-enterable-mlo / 6 = PATOCHE UNDERGROUND / 7 = JURASSIC CASINO / 8 = MOLO CASINO

    MapNames = { --RESOURCE NAME : MAP NUMBER (DON'T EDIT THE NUMBER)
        ["molo_casino"] = 8,
        ["tstudio_jurassic_jackpot"] = 7,
        ["patoche_casino"] = 6,
        ["k4mb1-casino"] = 2,
        ["uj_casino"] = 1,
        ["cfx-gabz-casino"] = 3,
    ...
    MenuType = "DEFAULT", --DEFAULT = Standalone menu // MENU = esx_menu_default // OX = ox_lib (check also fxmanifest)
