Config = {
	...
	CarLifts = {
		...
		CarLiftUse = {					-- Make use of carlifts in mlos, if they have separated parts + collision, they can be used
			...
			[`denis3d_carlift_02`] = {
				...
				offset = vector4(125.59, -3022.94, 7.04, 90.61)
			},
			-- Gabz Bennys Lifts
			[`gabz_bennys_prop_carlift_03`] = {
				lift = `gabz_bennys_prop_carlift_01`,
				offset = vector3(-125.96, -3022.52, -7.04)
			},
			-- RFC LS CUSTOMS
			[1802445854] = {
				lift = -1174339517,
	...
	Odometer = {
		...
		odoCustomisation = {
			...
			screenPosition = { top = 95, left = 90 },				-- where on the screen it will appear (percentages) default bottom right
			backgroundColor = { 0, 0, 0 },							-- the colour of the huds background
			backgroundColorTransparency = 0.0,						-- the transparency of the huds background

			backgroundBorderTransparency = 0.0,						-- background outline transparency (0.0 hides it, max 1.0)
			...
			backgroundShadowTransparency = 0.0,						-- background shadow/glow transparency (0.0 hides it, max 1.0)
			...
			backgroundInnerShadowTransparency = 0.0,				-- background shadow/glow transparency (0.0 hides it, max 1.0)
			...
			iconSize = 0.25,										-- How big the icons will be (attempts to scale between resolutions)
			iconColorMax = { 10, 10, 10, 0 },							-- The colour icons will be if full health
			iconColorMin = { 255, 0, 0, 1 },							-- The colour icons will be if a low health
			...
			mileagetextSize = '1.6vh',								-- Milage text size
			mileagetextColor = { 255, 255, 255 },					-- Milage Colour
			mileagetextGlow = '0 0 4px',							-- Glow/Shadow effect
		...
		speedCustomisation = {
			SpeedLocation = { top = '70%', left = '101%' },			-- Location of the whole speedometer on the screen
			SpeedSize = '14vh',
			...
			BorderTrans = 0.0,										-- The semi-circle border transparency

			BackgroundCol = { 0, 0, 0 },							-- Background colour
			BackgroundTrans = 0.0,									-- Background Transparency
			...
			MarkerColour = {12, 206, 231},				-- Colour of text if classed as "High"
			...
			digitalSpeedLoc = { top = 140, left = -168 },				-- Location of the numbers (defaults to the center)
			digitalSpeedSize = '3vh',								-- The font size

			NeedleType = 1,											-- Change between 1, 2, 3

			SpeedNeedleLength = '8.0vh',							-- Speedometer Needle Length
			SpeedNeedleWidth = '0.8vh',								-- Speedometer Needle Width
			...
			rpmMeterLocation = 'translate(-35vh, 4.5vh)',			-- RPM Meter location in relation to the speedometer
			rpmMeterSize = '25vh',
			rpmNeedleLength = '10.0vh',								-- Speedometer Needle Length
			rpmNeedleWidth = '0.4vh',								-- Speedometer Needle Width
			...
			fuelMeterLocation = 'translate(-40.5vh, 14vh)',			-- Fuel Meter location in relation to the speedometer
			fuelMeterSize = '5vh',
