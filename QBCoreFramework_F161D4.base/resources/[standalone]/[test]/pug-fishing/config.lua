...
----------
----------
Config.TournamentCooldowns = 60 -- (Minutes) how much time inbetween tournaments | Default is set to 2 hours and 30 minutes (# In minutes)
Config.LengOfActiveTournament = 20 -- (Minutes) how much time the actual torunament happens for | Default is set to 35 minutes (# In minutes)
Config.TournamentTimeToSignUp = 10 -- (Minutes) How long do player have to sign up after a tournament becomes available aka how many seconds is Config.TournamentCooldowns | Default is set to 15 minutes
----------
----------
Config.TournamentPed = `s_m_m_trucker_01` -- Fishing Tournament ped
Config.TournamentPedLoc = vector4(-1597.48, 5201.87, 3.36, 242.71) -- tournament ped location
----------
----------
