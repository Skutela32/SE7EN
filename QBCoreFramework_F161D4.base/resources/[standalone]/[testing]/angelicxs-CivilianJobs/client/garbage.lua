...
local Garbage_Options = {
    ...
    Payment = {
        ...
        materialList = { -- List of items to give to play when they RECEIVE PAYMENT
            {name = 'rubber', min = 1, max = 10},
            {name = 'plastic', min = 1, max = 10},
            {name = 'metalscrap', min = 1, max = 10},
            {name = 'copper', min = 1, max = 10},
            {name = 'iron', min = 1, max = 10},
            {name = 'steel', min = 1, max = 10},
        },
