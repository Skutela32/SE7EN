...
Taxi_Options.Payment = { -- Pays on drop off of NPC
    flatRate = false,
    flatRateAmount = 70,
    DistanceMultiplier = 0.5, -- Only applies if flatRate = false, pays driver based on multiplying distance from pick up to drop off.
    ...
    materialList = { -- List of items to give to play when they RECEIVE PAYMENT
        {name = 'rubber', min = 1, max = 1},
        {name = 'plastic', min = 1, max = 1},
        {name = 'metalscrap', min = 1, max = 1},
        {name = 'copper', min = 1, max = 1},
        {name = 'iron', min = 1, max = 1},
        {name = 'steel', min = 1, max = 1},
    },
}
