Config.Locations = {
    ["Washing"] = {
        Enable = true,
        positions = {
            { name = "Refinary", coords = vec3(1109.9, -2008.28, 31.06), sprite = 467, col = 3, disp = 6, blipEnable = true }, 
        },
    },
    ["Panning"] = {
        Enable = true,
        positions = {
            ["Rich_Paydirt"] = {
                ...
                Blip = { -- The location where you enter the mine
                    Enable = true,
                    name = "Rich Refinary",
                    coords = vector3(853.68, -2432.72, 28.07),
                    sprite = 467, col = 5,
                },
                Positions = {
                    { coords = vector4(853.68, -2432.72, 28.07, 180), w = 22.1, d = 4.0 },
                }
            },
            --[[["Tongva"] = {
                Enable = false,
    ...
    ["Mines"] = {
        ["Foundary"] = {
            ...
            Blip = { -- The location where you enter the mine
                Enable = false,
                name = "Foundary",
                coords = vec4(1074.89, -1988.19, 3.89, 235.07),
                sprite = 436, col = 1,
            },
            Lights = {
                Enable = true,
                ...
                positions = {
                    vec4(1106.46, -1991.44, 3.49, 185.78),
                },
            },
            Store = {
