...
Config.HudSettingsCommand = '' -- Command for open hud settings
...
Config.DefaultSpeedometerSize = 0.0 -- 0.5 - 1.3
...
Config.WaterMarkText1 = "Project" -- Top right server text
Config.WaterMarkText2 = "Syndicate"  -- Top right server text
...
Config.GetVehicleFuel = function(vehicle) -- you can change LegacyFuel export if you use another fuel system 
    if Config.UseLegacyFuel then
        return exports["ti_fuel"]:getFuel( GetVehiclePedIsIn(PlayerPedId()) )
    else
