...
Config.Teleports = {
    [1] = { -- Level 5 Dealer
        [1] = {
            poly = { coords = vector3(-803.44, -224.11, 37.23), heading = 167.5, length = 2, width = 2 },
            allowVeh = false,
            label = '[E] Exit Dealership' 

        },
        [2] = {
            poly = { coords = vector3(519.76, -2639.42, -49.0), heading = 172.5, length = 2, width = 2 },
            allowVeh = false,
            label = '[E] Enter Dealership (Level 10)'
        },
        [3] = {
            poly = { coords = vector3(970.94, -2988.39, -39.65), heading = 172.5, length = 2, width = 2 },
            allowVeh = false,
            label = '[E] Enter Dealership (Level 5)'
        },
        [4] = {
            poly = { coords = vector3(-198.39, -580.67, 136.0), heading = 172.5, length = 2, width = 2 },
            allowVeh = false,
            label = '[E] Enter Dealership (Level 15)'
        }
    }--[[],
    [2] = {-- Level 10 Dealer
        [1] = { -- up
            poly = { coords = vector3(3540.74, 3675.59, 2.99), heading = 167.5, length = 2, width = 2 },
            allowVeh = false,
            label = '[E] Enter Dealership (Level 5)'
